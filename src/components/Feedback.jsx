...
const Feedback = () => {
  ...
  return (
    <div data-aos="fade-up" className={`${theme?`bg-gradient-to-br from-purple-50 to-pink-100`:`bg-gradient-to-br from-purple-800 to-pink-800`} py-12 px-6 rounded-2xl shadow-2xl max-w-[1200px] md:mx-auto ml-2 mr-2  my-12`}>
